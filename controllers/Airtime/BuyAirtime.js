...
export const BuyAirtime =  async(req, res)=>{
    ...
    try{
        ...
        var url = `https://smartrecharge.ng/api/v2/airtime/?api_key=${api_key}&product_code=${product_code}&phone=${phone}&amount=${amount}&callback=https://borrowlite.com/callback.php`
        ...
        .then(data => {
          console.log('data', data)
           if(data.error_code == "1983" && "1982" && "1978" && "1981"){
            const payload = {
                amount:total,
                user,
            }
